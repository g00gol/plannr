...
export default function AuthModal(props: AuthModalProps): React.ReactElement {
  ...
  return (
    ...
    >
      <div
        id="modal"
        className="load-slide-fast absolute inset-y-0 left-0 right-0 top-0 z-50 flex h-screen w-1/2 flex-wrap content-center justify-center bg-white opacity-90 duration-75"
