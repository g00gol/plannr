...
export const DirectionsContext = React.createContext<DirectionsContextType>(null!);

// create functions for mutating tripcontext here; will use replace instead of mutation for statefulness
export const DirectionsProvider = ({ children }: React.PropsWithChildren<{}>) => {
  ...
  return (
    <DirectionsContext.Provider value={{ currentTrip, tripName, setTripName, addPlace, removePlace, onSortEnd }}>
      {children}
